...
describe('gitlab controller', function () {
    ...
    describe('initialisation tests', function () {
        ...
        beforeEach(function () {
            ...
            $controller('gitlab as vm', { $scope: $scope });
            $scope.$apply();
        });
        ...
        it('should have "Load From gitlab" for its title', function () {

            expect($scope.vm.title).toEqual('Load From gitlab');
        });
